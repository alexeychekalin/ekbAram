  ...
  methods: {
    ...
    getCompany: function getCompany() {
      ...
      axios.get('/api/about').then(function (res) {
        _this2.name = res.data[0].name;
        _this2.address = res.data[0].address;
        _this2.code = res.data[0].code;
        _this2.inn = res.data[0].inn;
        _this2.email = res.data[0].email;
        _this2.phone = res.data[0].phone;
        _this2.iban = res.data[0].iban;
        _this2.swift = res.data[0].swift;
        _this2.bank = res.data[0].bank;
        _this2.baddress = res.data[0].baddress;
        _this2.licence = res.data[0].licence;
        _this2.branch = res.data[0].branch;
        _this2.accountNumber = res.data[0].accountNumber;
      })["catch"](function (error) {
        UIkit.notification({
          message: error,
          status: 'danger'
...
var render = function () {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _c("h1", { staticClass: "uk-text-center" }, [_vm._v("Company ")]),
      _vm._v(" "),
      _c(
        "form",
        {
