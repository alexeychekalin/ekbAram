...
var render = function () {
  ...
  return _c(
    ...
    {
      staticClass:
        "uk-flex uk-flex-center uk-flex-middle uk-background-muted uk-height-viewport",
      attrs: { "data-uk-height-viewport": "" },
    },
...
var staticRenderFns = [
  function () {
    ...
    return _c(
      ...
      {
        staticClass:
          "uk-position-bottom-center uk-position-small uk-visible@m uk-position-z-index",
      },
      [
        _c("span", { staticClass: "uk-text-small uk-text-muted" }, [
          _vm._v("© Autokat Recycle | BuiltWith "),
          _c(
            "a",
            {
              attrs: {
